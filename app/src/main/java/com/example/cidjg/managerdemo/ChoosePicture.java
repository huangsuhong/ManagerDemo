...
import com.example.cidjg.managerdemo.network.UploadUtil;
 ...
 * 说明：主要用于选择文件和上传文件操作
 */
public class ChoosePicture extends Activity implements OnClickListener,UploadUtil.OnUploadProcessListener {
     ...
     * 这里的这个URL是服务器环境URL
     */
   private static String requestURL =  "http://114.115.141.43:4040/webServer/";
    //private static String requestURL = " http://180.142.207.224";
